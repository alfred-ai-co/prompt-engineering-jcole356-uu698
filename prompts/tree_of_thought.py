TREE_OF_THOUGHT_PROMPT = """
  Given the following topic {input} and difficulty {difficulty} generate a quiz.
  ...
  If the difficulty is "easy" add a hint to the end of the question text
  ...
  "explanation" is an explanation of the correct answer
"""
